import { AreaForm } from "@/components/common/form/AreaForm";
      ...
      >
        <div className='flex flex-col laptop:flex-row items-center w-full spacing-gap laptop:gap-20'>
          ...
          >
            ...
            <p
              className='text-terciary-foreground text-[15px] leading-[180%] w-fit max-w-full 
              laptop:max-w-[600px] font-plus line-clamp-3 animate-fade-in delay-500 duration-300'
            >
              {description}
            </p>
          </div>
          {/* Area form */}
          <AreaForm formKey='area-form' area={title} />
        </div>
      </div>
    </section>
  );
