        ...
        <div className='flex flex-col laptop:flex-row items-center w-full spacing-gap laptop:gap-20'>
          ...
          >
            ...
            <div className='flex flex-col gap-2.5'>
              ...
              />
              <h2
                className='text-primary-foreground tracking-[-1.38px] text-left font-crimson line-clamp-4 
            ...
            <div
              className='w-[48px] h-[1px] bg-accent-solid hidden tablet:block 
            animate-fade-in delay-500 duration-300'
            ></div>
            <p
              className='text-terciary-foreground text-[15px] leading-[180%] w-fit max-w-full laptop:max-w-[600px] 
          ...
          {/* Service form */}
          <ServiceForm formKey='service-form' serviceId={value} />
        </div>
      </div>
    </section>
  );
