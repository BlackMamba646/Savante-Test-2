...
export const AreaForm = ({ formKey, area }: AreaFormProps) => {
  ...
  const {
    ...
    action: submitAreaInquiry,
    schema: areaInquirySchema,
    onSuccess: () => {
      setPhoneValue("");
    },
  });
  ...
  return (
    <form
      ...
      noValidate
      autoComplete='on'
      className='relative flex-1 max-w-full laptop:max-w-[600px] flex flex-col gap-0 p-0 backdrop-blur-[40px] 
