...
import { submitContactModal } from "@/app/actions/contact.action";
import { TextButton } from "../button/TextButton";
import { AgreeWithTC } from "../text/AgreeWithTC";
import { TextField } from "../input/TextField";
import { PhoneField } from "../input/PhoneField";
import { useFormAction } from "@/hooks/use-form-action";
import { contactModalSchema } from "@/lib/validations/lead.schema";
...
export const ContactModal = ({
  ...
  const {
    ...
    action: submitContactModal,
    schema: contactModalSchema,
    onSuccess: () => {
      setPhoneValue("");
      onClose();
    },
        ...
        >
          ...
          >
            <div className="flex flex-row justify-between w-full items-center">
              <h4 className="text-primary-foreground font-crimson tracking-[-1.08px] leading-[120%]">
                {title}
              </h4>
              <button
                onClick={onClose}
