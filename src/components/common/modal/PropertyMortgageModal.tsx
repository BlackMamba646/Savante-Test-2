...
interface PropertyMortgageModalProps {
  isOpen: boolean;
  onClose: () => void;
  propertyName?: string;
...
export const PropertyMortgageModal = ({
  isOpen,
  onClose,
  propertyName,
  totalLoanAmount,
  message = 'Property mortgage inquiry',
}: PropertyMortgageModalProps) => {
  ...
  const {
    ...
    action: submitPropertyMortgageForm,
          ...
          >
            ...
            >
              ...
              <input
                type='hidden'
                name='budget'
                value={getBudgetFromLoanAmount(Number(totalLoanAmount) || 0)}
              />
              <input
                type='hidden'
                name='message'
                ...
                <div className='flex-1 hidden tablet:flex flex-col gap-1 opacity-40 cursor-not-allowed select-none'>
                  ...
                  >
                    <input
                      ...
                      id='property'
                      value={propertyName || ""}
                      placeholder='Apartment In St Regis The Residence of service'
                      readOnly
                      disabled
              ...
              <div className='flex flex-col gap-2 mt-3 flex-1 tablet:flex-none justify-end tablet:justify-start'>
                <TextButton
                  type='submit'
                  text={isPending ? "Sending..." : "Send Application"}
                  state={isPending ? "disabled" : "default"}
