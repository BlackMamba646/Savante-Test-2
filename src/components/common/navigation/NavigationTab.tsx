  ...
  return (
    <article
      className={`hidden laptop:flex absolute -right-44.5 top-full dark
        bg-transparent z-999 transition-opacity duration-200 ${
          isOpen
    ...
    >
      <div
        className="py-10 px-16 max-w-[1100px] flex flex-row w-full gap-16 items-start content-start cursor-default"
        style={{
          background:
            "linear-gradient(0deg, var(--color-gray-color-stops-40, rgba(0, 2, 10, 0.40)) 0%, var(--color-gray-color-stops-40, rgba(0, 2, 10, 0.40)) 100%), var(--Color-Accent-Color, #001489)",
        }}
      >
