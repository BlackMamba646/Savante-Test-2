      ...
      <AnimatePresence>
        {isOpen && !disabled && (
          <motion.div
            ...
            className={`absolute top-full mt-2 bg-surface-background flex flex-col
              ...
              <AnimatePresence>
                {isMaxOpen && (
                  <motion.div
                    ...
                    className="flex flex-col max-h-[200px] overflow-y-auto scrollbar-hide mt-2"
                  >
                    {FILTER_PRICE.map((price) => (
                      <button
                        type="button"
                        ...
                        className={`text-[15px] leading-[180%] cursor-pointer 
                                hover:bg-surface-container-background hover:text-accent transition-colors 
                                duration-200 w-full py-2 rounded px-4 text-left ${
                                  maxValue === price.key
                                    ? "bg-accent/10 text-accent font-medium"
                                    : "text-primary-foreground"
                                }`}
