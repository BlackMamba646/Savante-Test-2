...
export const IdentificationBadge = ({ size = 20 }: IdentificationBadgeProps) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d='M6.25 15C6.68663 14.4178 7.2528 13.9453 7.90369 13.6199C8.55457 13.2944 9.27229 13.125 10 13.125C10.7277 13.125 11.4454 13.2944 12.0963 13.6199C12.7472 13.9453 13.3134 14.4178 13.75 15'
        stroke='currentColor'
        strokeWidth='1.2'
        strokeLinecap='round'
        strokeLinejoin='round'
