...
export const metadata: Metadata = {
  title: "Privacy Policy | Savante Realty",
  description: "Privacy Policy for Savante Realty website",
};

export default async function PrivacyPolicyPage() {
  try {
    const page = await APIService.findPrivacyPolicy();
    ...
    return (
      <main className='relative bg-white'>
        <section
          className='flex gap-5 max-w-[1440px] mx-auto flex-col spacing-padding-x'
        >
